            ...
            <div style="display: flex; align-items: flex-end; justify-content: space-between; flex-wrap: wrap; gap: 16px; padding-top: 8px; border-top: 1px solid #f1f5f9;">
                ...
                <div style="flex: 1; min-width: 280px;">
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 6px;">
                        ...
                        <span id="glossary-poster-badge" style="display: none;"></span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <input type="file" name="poster_file" accept="image/*" onchange="previewAndConvertImage(this, 'glossary_poster_image_input', 'glossary-poster-preview', 'glossary-poster-badge')" style="font-size: 0.82rem; color: #475569;">
                        <input type="text" id="glossary_poster_image_input" name="poster_image" value="{{ old('poster_image', $editItem->poster_image ?? '') }}" oninput="previewUrlImage(this, 'glossary-poster-preview')" placeholder="Image URL or auto-filled from upload" style="flex: 1; padding: 6px 10px; border: 1px solid #cbd5e1; border-radius: 4px; font-size: 0.82rem;">
                        <img id="glossary-poster-preview" src="{{ old('poster_image', $editItem->poster_image ?? '') }}" alt="Poster" style="height: 38px; border-radius: 4px; border: 1px solid #cbd5e1; display: {{ !empty(old('poster_image', $editItem->poster_image ?? '')) ? 'block' : 'none' }};" onerror="this.style.display='none';">
                    </div>
                </div>
